...
{   
    ...
    Eigen::Vector3f AP = {x-_v[0].x(),y-_v[0].y(),0-_v[0].z()};
    Eigen::Vector3f BP = {x-_v[1].x(),y-_v[1].y(),0-_v[1].z()};
    Eigen::Vector3f CP = {x-_v[2].x(),y-_v[2].y(),0-_v[2].z()};

    Eigen::Vector3f AB = {_v[1].x()-_v[0].x(), _v[1].y()-_v[0].y(), _v[1].z()-_v[0].z()};
    Eigen::Vector3f BC = {_v[2].x()-_v[1].x(), _v[2].y()-_v[1].y(), _v[2].z()-_v[1].z()};
    Eigen::Vector3f CA = {_v[0].x()-_v[2].x(), _v[0].y()-_v[2].y(), _v[0].z()-_v[2].z()};
